...
import com.itec.api.workflow.services.DeleteWorkflowUserGroupService;
...
public class DeleteWorkflowUserGroupController {

    BaseService service;

    public DeleteWorkflowUserGroupController(DeleteWorkflowUserGroupService service) {
