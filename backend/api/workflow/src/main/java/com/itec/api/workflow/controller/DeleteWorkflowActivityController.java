...
import com.itec.api.workflow.services.DeleteWorkflowActivityService;
...
public class DeleteWorkflowActivityController {

    BaseService service;

    public DeleteWorkflowActivityController(DeleteWorkflowActivityService service) {
