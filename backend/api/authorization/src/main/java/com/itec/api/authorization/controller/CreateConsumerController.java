...
import com.itec.api.authorization.services.CreateConsumerService;
...
public class CreateConsumerController extends BaseController<CreateConsumerService> {

    public CreateConsumerController(CreateConsumerService service) {
        super(service);
    }
