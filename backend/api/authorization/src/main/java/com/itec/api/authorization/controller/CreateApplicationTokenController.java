...
import com.itec.api.authorization.services.CreateApplicationTokenService;
...
public class CreateApplicationTokenController extends BaseController<CreateApplicationTokenService> {

    public CreateApplicationTokenController(CreateApplicationTokenService service) {
        super(service);
    }

    /**
     * Create a application token
     *
    ...
    public ResponseEntity<Object> execute(HttpServletRequest req,
        ...
        return ResponseEntity.ok()
                .header(SET_COOKIE, "app_authorization=" + result.getAppAuthorization())
                .body(result);
    }
