...
import com.itec.api.authorization.services.UpdateApplicationTokenService;
...
public class UpdateApplicationTokenController extends BaseController<UpdateApplicationTokenService> {


    public UpdateApplicationTokenController(UpdateApplicationTokenService service) {
        super(service);
    }
