...
const ProcessFormConfigTable=(props)=>{
  ...
  const handleClick = (e) => {
      ProcessFormConfigServices.CreateFormConfig(
      {
  ...
  const handleDelete = (item) => {
      ProcessFormConfigServices.DeleteFormConfig(
      {"processName":information.name,
       "name":item.name,
       "value":value,
  ...
  useEffect(() => {
    if(information!=null&&!!information.name){
        ProcessFormConfigServices.GetFormConfig({"processName":information.name})
...
export default ProcessFormConfigTable;